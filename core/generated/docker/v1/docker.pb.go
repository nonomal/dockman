...
const file_docker_v1_docker_proto_rawDesc = "" +
	"\n" +
	"\x16docker/v1/docker.proto\x12\tdocker.v1\"S\n" +
	...
	"\vComposeList\x12\x16.docker.v1.ComposeFile\x1a\x17.docker.v1.ListResponse\"\x00\x12J\n" +
...
var file_docker_v1_docker_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_docker_v1_docker_proto_goTypes = []any{
	(SORT_FIELD)(0),               // 0: docker.v1.SORT_FIELD
	(ORDER)(0),                    // 1: docker.v1.ORDER
	(*ContainerExecCmdInput)(nil), // 2: docker.v1.ContainerExecCmdInput
	(*ContainerExecRequest)(nil),  // 3: docker.v1.ContainerExecRequest
	(*Image)(nil),                 // 4: docker.v1.Image
	(*ManifestSummary)(nil),       // 5: docker.v1.ManifestSummary
	(*ListImagesRequest)(nil),     // 6: docker.v1.ListImagesRequest
	(*ListImagesResponse)(nil),    // 7: docker.v1.ListImagesResponse
	(*RemoveImageRequest)(nil),    // 8: docker.v1.RemoveImageRequest
	(*RemoveImageResponse)(nil),   // 9: docker.v1.RemoveImageResponse
	(*ImagePruneResponse)(nil),    // 10: docker.v1.ImagePruneResponse
	(*ImagePruneRequest)(nil),     // 11: docker.v1.ImagePruneRequest
	(*ImagesDeleted)(nil),         // 12: docker.v1.ImagesDeleted
	(*Volume)(nil),                // 13: docker.v1.Volume
	(*ListVolumesRequest)(nil),    // 14: docker.v1.ListVolumesRequest
	(*ListVolumesResponse)(nil),   // 15: docker.v1.ListVolumesResponse
	(*CreateVolumeRequest)(nil),   // 16: docker.v1.CreateVolumeRequest
	(*CreateVolumeResponse)(nil),  // 17: docker.v1.CreateVolumeResponse
	(*DeleteVolumeRequest)(nil),   // 18: docker.v1.DeleteVolumeRequest
	(*DeleteVolumeResponse)(nil),  // 19: docker.v1.DeleteVolumeResponse
	(*Network)(nil),               // 20: docker.v1.Network
	(*ListNetworksRequest)(nil),   // 21: docker.v1.ListNetworksRequest
	(*ListNetworksResponse)(nil),  // 22: docker.v1.ListNetworksResponse
	(*CreateNetworkRequest)(nil),  // 23: docker.v1.CreateNetworkRequest
	(*CreateNetworkResponse)(nil), // 24: docker.v1.CreateNetworkResponse
	(*DeleteNetworkRequest)(nil),  // 25: docker.v1.DeleteNetworkRequest
	(*DeleteNetworkResponse)(nil), // 26: docker.v1.DeleteNetworkResponse
	(*ContainerLogsRequest)(nil),  // 27: docker.v1.ContainerLogsRequest
	(*LogsMessage)(nil),           // 28: docker.v1.LogsMessage
	(*StatsResponse)(nil),         // 29: docker.v1.StatsResponse
	(*StatsRequest)(nil),          // 30: docker.v1.StatsRequest
	(*SystemInfo)(nil),            // 31: docker.v1.SystemInfo
	(*ListResponse)(nil),          // 32: docker.v1.ListResponse
	(*ContainerList)(nil),         // 33: docker.v1.ContainerList
	(*ContainerStats)(nil),        // 34: docker.v1.ContainerStats
	(*Port)(nil),                  // 35: docker.v1.Port
	(*Empty)(nil),                 // 36: docker.v1.Empty
	(*ContainerRequest)(nil),      // 37: docker.v1.ContainerRequest
	(*ComposeFile)(nil),           // 38: docker.v1.ComposeFile
	nil,                           // 39: docker.v1.Image.LabelsEntry
}
var file_docker_v1_docker_proto_depIdxs = []int32{
	39, // 0: docker.v1.Image.labels:type_name -> docker.v1.Image.LabelsEntry
	5,  // 1: docker.v1.Image.manifests:type_name -> docker.v1.ManifestSummary
	4,  // 2: docker.v1.ListImagesResponse.images:type_name -> docker.v1.Image
	12, // 3: docker.v1.ImagePruneResponse.deleted:type_name -> docker.v1.ImagesDeleted
	13, // 4: docker.v1.ListVolumesResponse.volumes:type_name -> docker.v1.Volume
	20, // 5: docker.v1.ListNetworksResponse.networks:type_name -> docker.v1.Network
	31, // 6: docker.v1.StatsResponse.system:type_name -> docker.v1.SystemInfo
	34, // 7: docker.v1.StatsResponse.containers:type_name -> docker.v1.ContainerStats
	38, // 8: docker.v1.StatsRequest.file:type_name -> docker.v1.ComposeFile
	...
	33, // 11: docker.v1.ListResponse.list:type_name -> docker.v1.ContainerList
	35, // 12: docker.v1.ContainerList.ports:type_name -> docker.v1.Port
	37, // 13: docker.v1.DockerService.ContainerStart:input_type -> docker.v1.ContainerRequest
	37, // 14: docker.v1.DockerService.ContainerStop:input_type -> docker.v1.ContainerRequest
	37, // 15: docker.v1.DockerService.ContainerRemove:input_type -> docker.v1.ContainerRequest
	37, // 16: docker.v1.DockerService.ContainerRestart:input_type -> docker.v1.ContainerRequest
	37, // 17: docker.v1.DockerService.ContainerUpdate:input_type -> docker.v1.ContainerRequest
	36, // 18: docker.v1.DockerService.ContainerList:input_type -> docker.v1.Empty
	30, // 19: docker.v1.DockerService.ContainerStats:input_type -> docker.v1.StatsRequest
	27, // 20: docker.v1.DockerService.ContainerLogs:input_type -> docker.v1.ContainerLogsRequest
	3,  // 21: docker.v1.DockerService.ContainerExecOutput:input_type -> docker.v1.ContainerExecRequest
	2,  // 22: docker.v1.DockerService.ContainerExecInput:input_type -> docker.v1.ContainerExecCmdInput
	38, // 23: docker.v1.DockerService.ComposeStart:input_type -> docker.v1.ComposeFile
	38, // 24: docker.v1.DockerService.ComposeStop:input_type -> docker.v1.ComposeFile
	38, // 25: docker.v1.DockerService.ComposeRemove:input_type -> docker.v1.ComposeFile
	38, // 26: docker.v1.DockerService.ComposeRestart:input_type -> docker.v1.ComposeFile
	38, // 27: docker.v1.DockerService.ComposeUpdate:input_type -> docker.v1.ComposeFile
	38, // 28: docker.v1.DockerService.ComposeList:input_type -> docker.v1.ComposeFile
	6,  // 29: docker.v1.DockerService.ImageList:input_type -> docker.v1.ListImagesRequest
	8,  // 30: docker.v1.DockerService.ImageRemove:input_type -> docker.v1.RemoveImageRequest
	11, // 31: docker.v1.DockerService.ImagePruneUnused:input_type -> docker.v1.ImagePruneRequest
	14, // 32: docker.v1.DockerService.VolumeList:input_type -> docker.v1.ListVolumesRequest
	16, // 33: docker.v1.DockerService.VolumeCreate:input_type -> docker.v1.CreateVolumeRequest
	18, // 34: docker.v1.DockerService.VolumeDelete:input_type -> docker.v1.DeleteVolumeRequest
	21, // 35: docker.v1.DockerService.NetworkList:input_type -> docker.v1.ListNetworksRequest
	23, // 36: docker.v1.DockerService.NetworkCreate:input_type -> docker.v1.CreateNetworkRequest
	25, // 37: docker.v1.DockerService.NetworkDelete:input_type -> docker.v1.DeleteNetworkRequest
	28, // 38: docker.v1.DockerService.ContainerStart:output_type -> docker.v1.LogsMessage
	28, // 39: docker.v1.DockerService.ContainerStop:output_type -> docker.v1.LogsMessage
	28, // 40: docker.v1.DockerService.ContainerRemove:output_type -> docker.v1.LogsMessage
	28, // 41: docker.v1.DockerService.ContainerRestart:output_type -> docker.v1.LogsMessage
	36, // 42: docker.v1.DockerService.ContainerUpdate:output_type -> docker.v1.Empty
	32, // 43: docker.v1.DockerService.ContainerList:output_type -> docker.v1.ListResponse
	29, // 44: docker.v1.DockerService.ContainerStats:output_type -> docker.v1.StatsResponse
	28, // 45: docker.v1.DockerService.ContainerLogs:output_type -> docker.v1.LogsMessage
	28, // 46: docker.v1.DockerService.ContainerExecOutput:output_type -> docker.v1.LogsMessage
	36, // 47: docker.v1.DockerService.ContainerExecInput:output_type -> docker.v1.Empty
	28, // 48: docker.v1.DockerService.ComposeStart:output_type -> docker.v1.LogsMessage
	28, // 49: docker.v1.DockerService.ComposeStop:output_type -> docker.v1.LogsMessage
	28, // 50: docker.v1.DockerService.ComposeRemove:output_type -> docker.v1.LogsMessage
	28, // 51: docker.v1.DockerService.ComposeRestart:output_type -> docker.v1.LogsMessage
	28, // 52: docker.v1.DockerService.ComposeUpdate:output_type -> docker.v1.LogsMessage
	32, // 53: docker.v1.DockerService.ComposeList:output_type -> docker.v1.ListResponse
	7,  // 54: docker.v1.DockerService.ImageList:output_type -> docker.v1.ListImagesResponse
	9,  // 55: docker.v1.DockerService.ImageRemove:output_type -> docker.v1.RemoveImageResponse
	10, // 56: docker.v1.DockerService.ImagePruneUnused:output_type -> docker.v1.ImagePruneResponse
	15, // 57: docker.v1.DockerService.VolumeList:output_type -> docker.v1.ListVolumesResponse
	17, // 58: docker.v1.DockerService.VolumeCreate:output_type -> docker.v1.CreateVolumeResponse
	19, // 59: docker.v1.DockerService.VolumeDelete:output_type -> docker.v1.DeleteVolumeResponse
	22, // 60: docker.v1.DockerService.NetworkList:output_type -> docker.v1.ListNetworksResponse
	24, // 61: docker.v1.DockerService.NetworkCreate:output_type -> docker.v1.CreateNetworkResponse
	26, // 62: docker.v1.DockerService.NetworkDelete:output_type -> docker.v1.DeleteNetworkResponse
